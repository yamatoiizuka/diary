          ...
          <p
            dangerouslySetInnerHTML={{
              __html: typesetter.render(`
                ...
                <br />
                <br />
                GitHubで<a target="_blank" href="https://github.com/yamatoiizuka/diary">ソースコード</a>を公開しています。CMSについて<a target="_blank" href="https://zenn.dev/yamatoiizuka/articles/79ad1b2099b966">記事</a>を書きました。文字組に<a target="_blank" href="https://palt.typesetting.jp/">palt-typesetting</a>を使っています。
              `),
            }}
          />
        </div>
